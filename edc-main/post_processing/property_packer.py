...
def normalize_entity_type(t: str) -> str:
    ...
    mapping = {
        ...
        "benh": "Disease",
        "drug": "Drug",
        "thuốc / nhóm thuốc": "Drug",
        "thuốc": "Drug",
        "nhóm thuốc": "Drug",
        "symptom": "Symptom",
        "triệu chứng": "Symptom",
        "trieu chung": "Symptom",
        "xét nghiệm / thăm dò": "Diagnostic Test",
        "xét nghiệm": "Diagnostic Test",
        "thăm dò": "Diagnostic Test",
        "diagnostic test": "Diagnostic Test",
        "clinical metric": "Clinical Metric",
        "clinicalmetric": "Clinical Metric",
        "chỉ số lâm sàng": "Clinical Metric",
        "chi so lam sang": "Clinical Metric",
        "dosage value": "Dosage Value",
        "dosagevalue": "Dosage Value",
        "liều dùng": "Dosage Value",
        "lieu dung": "Dosage Value",
        "treatment target": "Treatment Target",
        "mục tiêu kiểm soát": "Treatment Target",
        "muc tieu kiem soat": "Treatment Target",
        "risk factor": "Risk Factor",
        "yếu tố nguy cơ": "Risk Factor",
        "yeu to nguy co": "Risk Factor",
        "risk scale": "Risk Scale",
        "thang điểm đánh giá": "Risk Scale",
        "thang điểm": "Risk Scale",
        "thang diem danh gia": "Risk Scale",
        "complication": "Complication",
        "biến chứng": "Complication",
        "bien chung": "Complication",
