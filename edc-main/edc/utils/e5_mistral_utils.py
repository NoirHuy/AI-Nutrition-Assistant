...
try:
    ...
    # huggingface_hub >= 0.16 removed Repository; create_repo is still available
    try:
        from huggingface_hub import create_repo
    except ImportError:
        pass
    Repository = None  # Not used during inference
...
try:
    ...
    get_full_repo_name = None  # Removed in newer transformers; not used during inference
